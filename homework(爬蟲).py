...
# for each_acticle in acticle_title_html:
#     title = each_acticle.select('a')[0].text
#     urltitle = 'https://www.ptt.cc' + each_acticle.select('a')[0]['href']
#     resArticle = requests.get(urltitle, headers)
#     soupArticle = BeautifulSoup(resArticle.text, 'html.parser')
#     print(soupArticle)
#     authod = soupArticle.select()
#     articleContent = soupArticle.select()
